    ...
    const t = (key) => {
        const translations = {
            fr: {
                ...
                proj2Title: 'Détection de Malware (Hackathon)',
                proj2Desc: 'Script d\'analyse de fichiers et d\'atténuation des menaces développé lors d\'un hackathon de cybersécurité.',
                proj3Title: 'Lab de Simulation d\'Attaques',
                proj3Desc: 'Mise en place de laboratoires réseaux pour la simulation d\'attaques et l\'analyse de risques (Cisco, TryHackMe).',
                // Categories
                catAll: 'Tous',
                catWeb: 'Web',
                catMobile: 'Mobile',
            ...
            en: {
                ...
                proj2Title: 'Malware Detection (Hackathon)',
                proj2Desc: 'Implementation of a malware detection script during a cybersecurity hackathon, focusing on file analysis.',
                proj3Title: 'Attack Simulation Lab',
                proj3Desc: 'Practical implementation of network laboratories for attack simulation and risk analysis (Cisco, TryHackMe).',
                // Categories
                catAll: 'All',
                catWeb: 'Web',
                catMobile: 'Mobile',
